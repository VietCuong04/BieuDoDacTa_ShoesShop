<template>
  <div>
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
        <h4 class="fw-bold mb-1"><i class="bi bi-tags me-2"></i>Quản lý Thương hiệu</h4>
        <p class="text-muted mb-0 small">{{ items.length }} thương hiệu</p>
      </div>
        ...
        <div class="table-responsive">
          <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
              ...
              <tr v-for="(item, idx) in items" :key="item.maThuongHieu">
                <td class="ps-3 text-muted">{{ idx + 1 }}</td>
                <td class="fw-semibold">{{ item.tenThuongHieu }}</td>
                <td>
                ...
                <td class="text-center">
                  ...
                  <button class="btn btn-sm btn-outline-danger" @click="remove(item.maThuongHieu)" title="Xóa">
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title fw-bold">{{ isEdit ? 'Sửa' : 'Thêm' }} Thương hiệu</h5>
          ...
          <form @submit.prevent="save">
            <div class="modal-body">
              <div class="mb-3">
                ...
                <input v-model="form.tenThuongHieu" class="form-control" required placeholder="Nhập tên thương hiệu" />
              </div>
              <div class="mb-3">
...
const form = ref({ tenThuongHieu: '', trangThai: 1 })
...
function openAdd() {
  isEdit.value = false
  editId.value = null
  form.value = { tenThuongHieu: '', trangThai: 1 }
  showModal.value = true
}

function openEdit(item) {
  isEdit.value = true
  editId.value = item.maThuongHieu
  form.value = { tenThuongHieu: item.tenThuongHieu, trangThai: item.trangThai }
  showModal.value = true
}
